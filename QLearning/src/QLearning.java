...
public class QLearning {    
    ...
    void runLearningLoop(QLearning app, QTable q) throws Exception {
        int moveCounter=0;
    ...
    public static void RunSim(QLearning app, QTable q) 
    {
    	q.explorationChance -= 0.05f;
    	if(q.explorationChance<-0.1) 
    	{
    		return;
    	}
    	System.out.println("-----------------------------------------New Sim--------------------------------------; Exp: " + q.explorationChance);
    	try{
            app.runLearningLoop(app, q);
        } catch (Exception e){
        	e.printStackTrace();;
